...
void binary_s(int s[],int n)
{
    ...
    cout<<"avarage: "<<static_cast<double>(t)/static_cast<double>(n)<<endl;
}
void find_a(int s[],int n)
{
    int t=0;
    for(int i=0;i<n;i++)
    {
...
```
测试结果：
>How much number want to add: 10  
1 2 3 4 5 6 7 8 9 0  
avarage: 5.5avarage: 3.8  

最终结果表明二分查找使用的次数平均为穷举搜索的70%